...
const draws = [
  { date: "2024-01-01", labName: "LabA", items: [
    ...
    { symbol: "TC", analysis: "Total Cholesterol", loinc: "2093-3", original: uv(200, "mg/dL"), us: uv(200, "mg/dL"), si: uv(5.2, "mmol/L") },
    { symbol: "HDL-C", analysis: "HDL Cholesterol", loinc: "2085-9", original: uv(50, "mg/dL"), us: uv(50, "mg/dL"), si: uv(1.3, "mmol/L") },
    { symbol: "T-BIL", analysis: "Total Bilirubin", loinc: "1975-2", original: uv(0.9, "mg/dL"), us: uv(0.9, "mg/dL"), si: uv(15, "umol/L") },
    { symbol: "D-BIL", analysis: "Direct Bilirubin", loinc: "1968-7", original: uv(0.2, "mg/dL"), us: uv(0.2, "mg/dL"), si: uv(3, "umol/L") },
  ] },
];
...
describe("buildLabView — end-to-end", () => {
  ...
  it("injects derived markers (I-BIL from T-BIL − D-BIL)", () => {
    const ibil = view.matrix.rows.find((r) => r.symbol === "I-BIL")!;
